...
public class LevelManager : MonoBehaviour
{
   ...
   [HideInInspector] public int shotCount = 0;              //count to store available shots
    ...
    public void SpawnLevel(int levelIndex)
    {
      ...
      UIManager.instance.currentLevelTxt.text = "Level: " + (levelIndex + 1).ToString();
        ...
        UIManager.instance.ShotText.text = "Strikes: " + shotCount.ToString();                        //set the ShotText text
                                                                   //then we Instantiate the ball at spawn position
        GameObject ball = Instantiate(ballPrefab, ballSpawnPos, ballPrefab.transform.rotation);
    ...
    public void ShotTaken()
    {
        if (shotCount > 0)                                          //if shotcount is more than 0
        {
            ...
            UIManager.instance.ShotText.text = "Strikes: " + shotCount;      //set the text
